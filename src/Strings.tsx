...
export const RESUME_LINK: ExperienceDetailType[] = [
  {
    ...
    redirect: "/blob/main/src/images/VenkatSai_Putagumpalla_resume.pdf",
  },
];
...
export const PROJECTS_DETAILS: ExperienceDetailType[] = [
  {
    ...
    image: "/blob/main/src/images/twitterClone.jpg",
    description:
  ...
  },
  {
    ...
    image: "/blob/main/src/images/movieReviews.jpg",
    description:
  ...
  {
    title: "Gator Taxi",
    image: "/blob/main/src/images/gatorTaxi.jpg",
    description:
