...
export const RESUME_LINK: ExperienceDetailType[] = [
  {
    ...
    redirect: "dist/assets/VenkatSai_Putagumpalla_resume.pdf",
  },
];
...
export const PROJECTS_DETAILS: ExperienceDetailType[] = [
  {
    ...
    image: "dist/assets/twitterClone.jpg",
    description:
  ...
  },
  {
    ...
    image: "dist/assets/movieReviews.jpg",
    description:
  ...
  {
    title: "Gator Taxi",
    image: "dist/assets/gatorTaxi.jpg",
    description:
