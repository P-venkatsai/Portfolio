...
export const RESUME_LINK: ExperienceDetailType[] = [
  {
    ...
    redirect: "/Portfolio/src/assets/images/VenkatSai_Putagumpalla_resume.pdf",
  },
];
...
export const PROJECTS_DETAILS: ExperienceDetailType[] = [
  {
    ...
    image: "/Portfolio/src/assets/images/twitterClone.jpg",
    description:
  ...
  },
  {
    ...
    image: "/Portfolio/src/assets/images/movieReviews.jpg",
    description:
  ...
  {
    title: "Gator Taxi",
    image: "/Portfolio/src/assets/images/gatorTaxi.jpg",
    description:
