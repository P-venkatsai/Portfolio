...
export const RESUME_LINK: ExperienceDetailType[] = [
  {
    ...
    redirect:
      "https://raw.githubusercontent.com/P-venkatsai/Portfolio/main/src/images/VenkatSai_Putagumpalla_resume.pdf",
  },
];
...
export const PROJECTS_DETAILS: ExperienceDetailType[] = [
  {
    ...
    image:
      "https://raw.githubusercontent.com/P-venkatsai/Portfolio/main/src/images/twitterClone.jpg",
    description:
  ...
  },
  {
    ...
    image:
      "https://raw.githubusercontent.com/P-venkatsai/Portfolio/main/src/images/movieReviews.jpg",
    description:
  ...
  },
  {
    title: "Gator Taxi",
    image:
      "https://raw.githubusercontent.com/P-venkatsai/Portfolio/main/src/images/gatorTaxi.jpg",
    description:
